...
1. 安装MindStudio Insight插件包。
    ...
    > [!NOTE] 说明   
    > 在安装插件包前，请先确认当前用户的umask设置，推荐设置为“0027”，具体建议请参见[安全声明](https://gitcode.com/Ascend/msinsight/blob/master/docs/zh/user_guide/security_statement.md)。
...
5. 开启MindStudio Insight插件后，重复操作[3](#jupyter_3)，打开MindStudio Insight工具。
    ...
    **注意事项**   
    ...
    - 请关注使用JupyterLab插件方式安装MindStudio Insight后，使用时的安全风险，具体可参见[安全声明](https://gitcode.com/Ascend/msinsight/blob/master/docs/zh/user_guide/security_statement.md)。
